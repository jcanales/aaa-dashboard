...
**Backend:** Node.js 20 + Express + PostgreSQL 15 + Prisma in `/backend/`. Running on port 3001.
...
**How to apply:** When modifying UI, match existing Radix UI/shadcn component patterns. New API routes go in backend/src/api/routes/. New pages go in src/pages/ with routes in src/App.tsx.
